      ...
      >
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">QuizVerse'e hoş geldiniz!</p>
          </div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              >
                Hesabınız yok mu?{" "}
                <Link href="/auth/register" className="text-orange-600 hover:text-orange-700 font-medium hover:underline transition-colors">
                  Kayıt Ol
                </Link>
              </motion.p>
            </form>
