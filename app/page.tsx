...
const HomePage = () => {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
            <h1 className="text-5xl font-bold text-orange-600 mb-6">Bilgi Yarışması</h1>
            <p className="text-lg text-center mb-8 max-w-2xl">
                Bilgi Yarışması, genel kültürünüzü test etmek için harika bir fırsat! 
                Farklı kategorilerde sorularla dolu bu yarışmada, en yüksek puanı almak için mücadele edin.
            </p>
            ...
            <div className="bg-white shadow-md rounded-lg p-6 mb-10 max-w-2xl">
                <h2 className="text-3xl font-semibold text-gray-800 mb-4">Neden Katılmalısınız?</h2>
                <p className="text-gray-600 mb-4">
                    Bilgi Yarışması, eğlenceli ve öğretici bir deneyim sunar. 
                    Arkadaşlarınızla yarışarak hem eğlenir hem de yeni bilgiler öğrenirsiniz.
                </p>
                <p className="text-gray-600 mb-4">
                    En yüksek puanı alan yarışmacılarımız sürpriz ödüller kazanma şansına sahip!
                </p>
            </div>

            {/* Kategoriler Bölümü */}
            <div className="bg-white shadow-md rounded-lg p-6 mb-10 max-w-2xl">
                <h2 className="text-3xl font-semibold text-gray-800 mb-4">Kategoriler</h2>
                <p className="text-gray-600 mb-4">
                    Yarışmamızda çeşitli kategorilerde sorular bulunmaktadır. İşte bazıları:
                </p>
            ...
            <div className="bg-white shadow-md rounded-lg p-6 mb-10 max-w-2xl">
                <h2 className="text-3xl font-semibold text-gray-800 mb-4">Lider Tablosu</h2>
                <p className="text-gray-600 mb-4">
                    Yarışmamızda en yüksek puanı alan yarışmacılar, lider tablosunda yer alır. 
                    Kendinizi diğer yarışmacılarla karşılaştırarak ne kadar ilerlediğinizi görebilirsiniz.
                </p>
            ...
            <div className="bg-white shadow-md rounded-lg p-6 mb-10 max-w-2xl text-center">
                ...
                <p className="text-gray-600 mb-4">
                    Herhangi bir sorunuz veya geri bildiriminiz mi var? 
